        ...
        6566: (e, n, t) => {
            ...
            !(function () {
                ...
                r.prototype = {
                    ...
                    unload: function () {
                        for (
                            var e = this || a, n = e._howls.length - 1;
                            n >= 0;
                            n--
                        )
                            e._howls[n].unload()
                    ...
                    _unlockAudio: function () {
                        ...
                        if (!e._audioUnlocked && e.ctx) {
                            ...
                            var n = function (t) {
                                for (
                                    ;
                                    e._html5AudioPool.length < e.html5PoolSize;
                ...
                i.prototype = {
                    init: function (e) {
                        ...
                        return (
                            ...
                            (n._sprite = e.sprite || {}),
                            (n._src =
                                'string' != typeof e.src ? e.src : [e.src]),
                    ...
                    play: function (e, n) {
                        ...
                        if (o && !u._paused)
                            return n || t._loadQueue('play'), u._id
                        t._webAudio && a._autoResume()
                        var s = Math.max(
                                0,
                                u._seek > 0 ? u._seek : t._sprite[e][0] / 1e3
                            ),
                            _ = Math.max(
                                0,
                                (t._sprite[e][0] + t._sprite[e][1]) / 1e3 - s
                            ),
                        ...
                        for (var d = 0; d < n.length; d++)
                            (t = o._soundById(n[d])) &&
                                ...
                                o._webAudio && t._node && !t._muted
                                    ? t._node.gain.setValueAtTime(
                                          e,
                                          a.ctx.currentTime
                                      )
                                    : t._node &&
                                      !t._muted &&
                                      (t._node.volume = e * a.volume()),
                            ...
                            if (d) {
                                if (
                                    ...
                                    ;(d._volume = e),
                                        ...
                                        d._node.gain.linearRampToValueAtTime(
                                            n,
                                            _
                                        )
                                }
                    ...
                    loop: function () {
                        ...
                        if (1 === r.length) {
                            if ('boolean' != typeof r[0])
                                return (
                                    !!(t = o._soundById(parseInt(r[0], 10))) &&
                                    t._loop
                                )
                            ;(e = r[0]), (o._loop = e)
                        } else
                            2 === r.length &&
                                ((e = r[0]), (n = parseInt(r[1], 10)))
                        for (
                            var a = o._getSoundIds(n), i = 0;
                            i < a.length;
                            i++
                        )
                            (t = o._soundById(a[i])) &&
                    ...
                    rate: function () {
                        ...
                        for (var d = 0; d < n.length; d++)
                            if ((t = o._soundById(n[d]))) {
                                ...
                                var s = o.seek(n[d]),
                                    _ =
                                        (o._sprite[t._sprite][0] +
                                            o._sprite[t._sprite][1]) /
                                            1e3 -
                                        s,
                                    l = (1e3 * _) / Math.abs(t._rate)
                                ;(!o._endTimers[n[d]] && t._paused) ||
                                    (o._clearTimer(n[d]),
                                    (o._endTimers[n[d]] = setTimeout(
                                        o._ended.bind(o, t),
                                        l
                                    ))),
                                    o._emit('rate', t._id)
                    ...
                    seek: function () {
                        ...
                        if (u) {
                            if (!('number' == typeof e && e >= 0)) {
                                if (t._webAudio) {
                                    var d = t.playing(n)
                                            ? a.ctx.currentTime - u._playStart
                                            : 0,
                                        s = u._rateSeek
                                            ? u._rateSeek - u._seek
                                            : 0
                    ...
                    _ended: function (e) {
                        ...
                        if (
                            ...
                            var r =
                                (1e3 * (e._stop - e._start)) / Math.abs(e._rate)
                    ...
                    _cleanBuffer: function (e) {
                        var n =
                            a._navigator &&
                            a._navigator.vendor.indexOf('Apple') >= 0
                        if (
                            a._scratchBuffer &&
                            e.bufferSource &&
                ...
                u.prototype = {
                    ...
                    create: function () {
                        var e = this,
                            n = e._parent,
                            t =
                                a._muted || e._muted || e._parent._muted
                                    ? 0
                                    : e._volume
                        return (
                            n._webAudio
                ...
                var d = {},
                    s = function (e) {
                        var n = e._src
                        if (d[n])
                            return (e._duration = d[n].duration), void c(e)
                    ...
                    p = function () {
                        if (a.usingWebAudio) {
                            ...
                            if (e && t && t < 9) {
                                var o = /safari/.test(
                                    a._navigator &&
                                        a._navigator.userAgent.toLowerCase()
                                )
                    ...
                    ;(HowlerGlobal.prototype._pos = [0, 0, 0]),
                            ...
                            for (
                                ...
                                if (u) {
                                    ...
                                    ;(u._stereo = e),
                                        (u._pos = [e, 0, 0]),
                                        u._node &&
                                            ((u._pannerAttr.panningModel =
                                                'equalpower'),
                                            (u._panner && u._panner.pan) ||
                                                n(u, r),
                                            'spatial' === r
                        ...
                        (Howl.prototype.pannerAttr = function () {
                            ...
                            if (1 === a.length) {
                                ...
                                2 === a.length &&
                                    ((e = a[0]), (t = parseInt(a[1], 10)))
                            for (
                                var i = r._getSoundIds(t), u = 0;
                                u < i.length;
                                u++
                            )
